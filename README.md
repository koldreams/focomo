...
Get help with Focomo, the revolutionary 3D tomato timer for iOS.
...
### Common Issues
- **Tomato won't respond to taps** → Check your device's touch sensitivity
- **3D graphics appear slow** → Close other apps and ensure iOS is updated
- **Focus mode not working** → Enable Do Not Disturb permissions for Focomo

### Get Support
- **Browse Documentation** → [Visit support site](https://koldreams.com/focomo)
- **Report Issues** → [GitHub Issues](https://github.com/koldreams/focomo/issues)
- **Request Features** → [New Feature Request](https://github.com/koldreams/focomo/issues/new)
